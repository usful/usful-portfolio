...
export default [
  {
    ...
    description: 'Usful means defining and maintaining a culture that will improve the human condition.',
    tags: ['Coach', 'Evolve', 'Manage'],
    picture: media[51],
    socialAccounts: [
    ...
    _id: GUID(),
    name: 'Rishabh Nag',
    description: 'Usful means pushing the limits of technology to inspire global change.',
